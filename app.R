...
server <- function(input, output,session) { 
  ...
  output$about_text <- renderText({
    paste("This dashboard serves as supporting information for the manuscript <b><i>The Effects of Short-Term PM2.5 and Wildfire Smoke Exposure on Cognitive Performance in US Adults.</i></b>",
          ...
          "<b>Abstract</b><br>",
          "There is increasing evidence that exposure to air pollution adversely impacts cognitive health. While fine particulate matter (PM2.5) ",
          "and wildfire smoke are pollutants of growing concern, there is limited research on how short-term exposure affects cognitive function. We aimed ",
          "to evaluate the cognitive effects of daily and sub-daily PM2.5 and smoke exposure. Cognitive performance data was ",
          "obtained for 10,288 contiguous United States (US) Lumosity users, age 18+, who completed 20 plays of a brain-training game targeted to ",
          "improve attention. We considered two measures of daily and sub-daily exposure: (1) daily and hourly PM2.5 estimates, obtained from a data fusion ",
          "of observations from US Environmental Protection Agency and PurpleAir monitors, and (2) smoke density, obtained from satellite images of",
          "smoke plumes. We used a retrospective longitudinal repeated measures design with a linear mixed effects model to test for associations between ",
          "short-term exposure metrics and Lumosity performance, overall and by age group, gender, habit, and region. Smoke analyses were only conducted in the",
          "western US. All measures of daily and sub-daily PM2.5 exposure were negatively associated with attention. A 10 ug/m3 increase in PM2.5 the day",
          " of gameplay was associated with 44.28 (95% CI: -84.27, -4.28) and 26.41 (95% CI: -47.90, -4.91) point decrease in score in the western and contiguous US, respectively.",
          "The effects were most pronounced in western US users, habitual players, and the elderly (70+), with no observed differences by gender. The presence of medium and heavy smoke density in the days ",
          "and weeks prior to play were also negatively associated with performance. Heavy smoke density the day before gameplay was associated with a 119.30 (95% CI: -212.24, -26.36)",
          "point decrease in score relative to no smoke. Younger users (18-29), habitual players, and men were most affected. Overall, our results indicate that short-term exposure to",
          "PM2.5 and wildfire smoke adversely impacts attention in adults, but further research is needed to elucidate these relationships.",
          "<br><br>",
          "<b>Authors:</b> Stephanie E. Cleland, Lauren H. Wyatt, Linda Wei, Naman Paul, Amrita Patil, J. Jason West, Marc L. Serre, Sarah B. Henderson, Ana G. Rappold")
  })
